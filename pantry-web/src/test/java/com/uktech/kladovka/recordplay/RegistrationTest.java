...
public class RegistrationTest {
  ...
  public void registration() {
    ...
    driver.findElement(By.name("email")).sendKeys("test11@gmail.com");
    ...
    driver.findElement(By.name("middleName")).sendKeys("Ivanovych");
    driver.findElement(By.name("phone")).click();
    driver.findElement(By.name("phone")).sendKeys("+380663636986");
    driver.findElement(By.id("password")).click();
    driver.findElement(By.id("password")).sendKeys("12345");
    driver.findElement(By.id("passwordConfirm")).click();
    driver.findElement(By.id("passwordConfirm")).sendKeys("12345");
    driver.findElement(By.id("sbmBtn")).click();
    driver.findElement(By.name("email")).sendKeys("test11@gmail.com");
    driver.findElement(By.name("password")).click();
    driver.findElement(By.name("password")).sendKeys("12345");
    driver.findElement(By.cssSelector(".custom-control-label")).click();
    driver.findElement(By.cssSelector(".btn:nth-child(5)")).click();
    driver.findElement(By.linkText("Balance of Goods")).click();
    driver.findElement(By.linkText("Catalog")).click();
    driver.findElement(By.linkText("test11@gmail.com")).click();
